      ...
      <div className="w-full max-w-lg p-8 text-center">
        ...
        <div className="mb-6 p-4 bg-muted/50 rounded-lg text-left">
          <div className="flex items-center justify-between mb-3">
            <span className="text-sm font-medium">{t('emptyState.enabledIdeationTypes')}</span>
            <Button
              variant="ghost"
              size="sm"
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">
                    {t(`typeLabels.${type}`, { defaultValue: IDEATION_TYPE_LABELS[type] })}
                  </span>
                </div>
                <Switch
        ...
        {hasToken === false && !isCheckingToken && (
          <p className="mt-3 text-sm text-muted-foreground">
            ...
            {t('emptyState.claudeTokenWarning')}
          </p>
        )}
      </div>
    </div>
